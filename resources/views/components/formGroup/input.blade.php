...
<div class="col-md-{{ array_get($params, 'col', '12') }} {{ $errors->has(array_get($params, 'name')) ? 'has-error' : '' }}">
    {!! Form::label(array_get($params, 'name'),array_get($params, 'label')) !!}
    {{-- {{ $errors->has(array_get($params, 'name')) ? "<small class=\"text-danger\"> $errors->first(array_get($params, 'name')) </small>" : '' }} --}}
